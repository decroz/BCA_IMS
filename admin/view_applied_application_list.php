<?php
$title = 'Applied for Admission Candidate Details';
      ...
      <div class="table-responsive ">
        <table class="table table-bordered table-hover table-striped ">
          ...
          <tr>
           ...
           <tr>
             <th class="bg-gray-900 text-light">Symbol no. </th>
             <td><?php echo $d['school_symbol_no'] ?></td>
           </tr>
       </table>
     </div>
   </div>
   ...
   <div class='card'>
    <div class="table-responsive ">
      <table class="table table-bordered table-hover table-striped ">
        ...
        <tr>
           <tr>
             <th class="bg-gray-900 text-light">Collage name</th>
         ...
         <tr>
           <th class="bg-gray-900 text-light">Symbol no. </th>
           <td><?php echo $d['college_symbol_no'] ?></td>
         </tr>
         <tr>
         <th class="bg-gray-900 text-light">Transcript</th>
               <td>
                 <div class="thumbnail">
                   <a href="img/users/<?php echo $d['transcript'] ?>" target="_blank">
                     <?php $d['transcript'] ?> View <i class="fas fa-eye"></i></a>
                   </div>
                 </td>
          </tr>
     </table>
    ...
    <table class="table table-bordered table-hover table-striped ">
      ...
      <tr>
        <td >
         ...
         <a class="btn d-none float-right mx-2 col-md-2 d-md-inline-block  btn-md btn-info shadow-sm" href="accept_apply_ad.php?email=<?php echo $d['email']; ?>
                 && name=<?php echo $d['student_fname']?> <?php echo $d['student_mname']?> <?php echo $d['student_lname']; ?>">Accept</a>
         <a class="btn d-none float-right col-md-2 d-md-inline-block  btn-md btn-danger shadow-sm" href="decline_apply_ad.php?email=<?php echo $d['email']; ?>
