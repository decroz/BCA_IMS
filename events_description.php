...
require "connection.php";
$events_list=$_REQUEST['ida'];
$sql="SELECT * FROM events where created_at='$events_list'";
  ...
  <div class="row">
    <div class='col-7 mx-4 '>
      <?php foreach($data as $dis){ ?>
        <center style="position:relative;" class="m-auto"><img src="admin\img\<?php echo $dis['event_image']; ?>" alt="" class="img-fluid shadow" style="object-fit:contain;"></center>
